...
class AdjustmentState:
    ...
    last_adjustment_ambient: Optional[float] = None
    last_adjustment_target: Optional[float] = None
...
class OrchestrationAgent:
    ...
    def __init__(self, config: Config):
        ...
        self._google_voice_client: Optional[GoogleVoiceClient] = None
        ...
        self._latest_temperature: Optional[dict] = None
    ...
    def get_latest_temperature(self) -> Optional[dict]:
