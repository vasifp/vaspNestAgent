...
async def resolve_current_temperature(_, info) -> Optional[dict]:
...
def temperature_updates_resolver(temperature: dict, info) -> dict:
...
def adjustment_events_resolver(event: dict, info) -> dict:
